...
import com.nikhilverma.do_it.Ac_Splash
...
class FirebaseService : FirebaseMessagingService() {
    ...
    override fun onMessageReceived(message: RemoteMessage) {
        ...
        val intent = Intent(this, Ac_Splash::class.java)  // splash -> Ac_splash
        ...
        contentView.setImageViewResource(R.id.icon, R.mipmap.ic_launcher) // changes madee
